...
import ru.hh.android.plugin.feature_module.generator.steps.FeatureModuleDirsStructureStep.Companion.KEY_DI_MODULE_FOLDER
import ru.hh.android.plugin.feature_module.generator.steps.FeatureModuleDirsStructureStep.Companion.KEY_DI_PROVIDER_FOLDER
import ru.hh.android.plugin.feature_module.generator.steps.FeatureModuleDirsStructureStep.Companion.KEY_DOMAIN_INTERACTOR_FOLDER
import ru.hh.android.plugin.feature_module.generator.steps.FeatureModuleDirsStructureStep.Companion.KEY_DOMAIN_REPOSITORY_FOLDER
import ru.hh.android.plugin.feature_module.generator.steps.FeatureModuleDirsStructureStep.Companion.KEY_MAIN_FOLDER
import ru.hh.android.plugin.feature_module.generator.steps.FeatureModuleDirsStructureStep.Companion.KEY_MODULE_ROOT_FOLDER
import ru.hh.android.plugin.feature_module.generator.steps.FeatureModuleDirsStructureStep.Companion.KEY_PRESENTATION_PRESENTER_FOLDER
import ru.hh.android.plugin.feature_module.generator.steps.FeatureModuleDirsStructureStep.Companion.KEY_PRESENTATION_VIEW_FOLDER
import ru.hh.android.plugin.feature_module.generator.steps.FeatureModuleDirsStructureStep.Companion.KEY_REMOTE_DATA_API_FOLDER
import ru.hh.android.plugin.feature_module.generator.steps.FeatureModuleDirsStructureStep.Companion.KEY_RESOURCES_LAYOUT_FOLDER
import ru.hh.android.plugin.feature_module.generator.templates.FileTemplateData
import ru.hh.android.plugin.feature_module.generator.templates.ModuleFilesFactory
import ru.hh.android.plugin.feature_module.generator.templates.gitignore.IgnoreFileType
