...
internal class GarconSettingsFormState(
    ...
    internal companion object {
        operator fun invoke(
            config: GarconPluginConfig,
        ): GarconSettingsFormState = GarconSettingsFormState().also { it.set(config) }

        fun GarconSettingsFormState.set(config: GarconPluginConfig) {
        ...
        fun GarconSettingsFormState.isModified(originalConfig: GarconPluginConfig): Boolean {
        ...
        fun GarconPluginConfig.copyWithValuesFrom(state: GarconSettingsFormState) = this.copy(
