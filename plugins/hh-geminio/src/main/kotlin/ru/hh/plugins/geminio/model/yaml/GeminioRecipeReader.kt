...
import ru.hh.plugins.geminio.sdk.model.recipe.OptionalParams
...
import ru.hh.plugins.geminio.sdk.model.recipe.RequiredParams
...
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_OPTIONAL_PARAMS
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_OPTIONAL_PARAMS_CATEGORY
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_OPTIONAL_PARAMS_CONSTRAINTS
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_OPTIONAL_PARAMS_FORM_FACTOR
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_OPTIONAL_PARAMS_MIN_API
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_OPTIONAL_PARAMS_MIN_BUILD_API
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_OPTIONAL_PARAMS_REVISION
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_OPTIONAL_PARAMS_SCREENS
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_PARAMETER_AVAILABILITY
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_PARAMETER_CONSTRAINTS
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_PARAMETER_DEFAULT
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_PARAMETER_HELP
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_PARAMETER_ID
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_PARAMETER_NAME
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_PARAMETER_SUGGEST
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_PARAMETER_VISIBILITY
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_RECIPE
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_REQUIRED_PARAMS
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_REQUIRED_PARAMS_DESCRIPTION
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_REQUIRED_PARAMS_NAME
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_WIDGETS
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_WIDGETS_BOOLEAN_PARAMETER
import ru.hh.plugins.geminio.model.yaml.YamlKeys.KEY_WIDGETS_STRING_PARAMETER
