...
private fun GeminioRecipe.toParametersData(): GeminioRecipeParametersData {
    ...
    val moduleCreationParams =
        predefinedFeaturesSection.features[PredefinedFeature.ENABLE_MODULE_CREATION_PARAMS]
    ...
    if (moduleCreationParams != null) {
        ...
        val moduleNameStringParameter =
            moduleNameParameterData.parameter as AndroidStudioTemplateStringParameter
        val formattedModuleNameParameterData =
            PredefinedFeaturesSection.createFormattedModuleNameParameter(
        ...
        existingParametersMap[FEATURE_FORMATTED_MODULE_NAME_PARAMETER_ID] =
            formattedModuleNameParameterData.parameter
        existingParametersMap[FEATURE_PACKAGE_NAME_PARAMETER_ID] =
            packageNameParameterData.parameter
        existingParametersMap[FEATURE_SOURCE_SET_PARAMETER_ID] = sourceSetParameterData.parameter
        existingParametersMap[FEATURE_DEFAULT_SOURCE_CODE_FOLDER_PARAMETER_ID] =
            codeSourceSetFolderData.parameter
    }
    ...
    if (globalsSection.parameters.isNotEmpty()) {
        ...
        existingParametersMap[GLOBALS_SHOW_HIDDEN_VALUES_ID] =
            showHiddenGlobalsParameterData.parameter
