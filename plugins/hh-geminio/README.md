...
revision будет выше стандартного, а имя шаблонов будет совпадать, то Android Studio возьмёт именно ваш шаблон.
...
Для булевских выражений есть специальные значения - `true` / `false` + возможно использованиие только
